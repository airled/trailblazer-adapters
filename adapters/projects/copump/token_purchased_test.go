...
func TestTokenPurchasedIndexer(t *testing.T) {
	// taikoRPC := "https://rpc.taiko.xyz"
	// blocknumber := int64(772538)
	...
	// indexer := copump.NewTokenPurchasedIndexer(client, []common.Address{common.HexToAddress(copump.TokenPurchasedAddress)})
	...
	// assert.Equal(t, uint64(1723357103), whitelist[0].Time)
